...
namespace DbContextPOCO.Entity
{
    ...
    public class UserProfileConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UserProfile>
    {
        ...
        public UserProfileConfiguration(string schema)
        {
            ...
            Property(x => x.UserProfileBirthDay).HasColumnName(@"UserProfile_Birth_Day").HasColumnType("int").IsRequired();
            Property(x => x.UserProfileBirthMonth).HasColumnName(@"UserProfile_Birth_Month").HasColumnType("int").IsRequired();
            Property(x => x.UserProfileBirthYear).HasColumnName(@"UserProfile_Birth_Year").HasColumnType("int").IsRequired();
            Property(x => x.UserProfileAge).HasColumnName(@"UserProfile_Age").HasColumnType("int").IsOptional();
            Property(x => x.UserProfileGender).HasColumnName(@"UserProfile_Gender").HasColumnType("nvarchar").IsRequired().HasMaxLength(10);
            ...
            Property(x => x.UserProfileAvatar).HasColumnName(@"UserProfile_Avatar").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(500);
